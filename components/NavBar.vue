<template>
  <nav class="navbar">
    ...
    <div class="loginCriar">
      <router-link to="/criarConta" class="criarConta">Criar Conta</router-link>
      <router-link to="/login" class="logar">Logar →</router-link>
    </div>
    <div @click="ativarNavBar" class="btn-navHambuguer">
